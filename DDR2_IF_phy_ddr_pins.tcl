...
lappend patterns ck_n ${instname}_alt_mem_phy_inst|clk|DDR_CLK_OUT\[*\].ddr_clk_out_n|auto_generated|ddio_outa\[*\]|dataout
	...
	set outputFileName "DDR2_IF_phy_autodetectedpins.tcl"
...
set DDR2_IF_phy_use_high_performance_timing 1
if {[namespace which -variable ::override_DDR2_IF_phy_use_high_performance_timing] != ""} {
	set DDR2_IF_phy_use_high_performance_timing $::override_DDR2_IF_phy_use_high_performance_timing
}
