...
// ============================================================
// Megafunction Name(s):
// 			DDR2_IF_phy_alt_mem_phy
// ============================================================
// Generated by altmemphy 9.1 [Altera, IP Toolbench 1.3.0 Build 222]
// ************************************************************
...
module DDR2_IF_phy (
	...
	DDR2_IF_phy_alt_mem_phy	DDR2_IF_phy_alt_mem_phy_inst(
	...
	defparam
		DDR2_IF_phy_alt_mem_phy_inst.FAMILY = "Cyclone III",
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR2",
		DDR2_IF_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		DDR2_IF_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		DDR2_IF_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		DDR2_IF_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		DDR2_IF_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		DDR2_IF_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		DDR2_IF_phy_alt_mem_phy_inst.DWIDTH_RATIO = 4,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 32,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 4,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 4,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 6000,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "6000 ps",
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 1106,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 1092,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		DDR2_IF_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 56,
		DDR2_IF_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		DDR2_IF_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		DDR2_IF_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		DDR2_IF_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info: <MEGACORE title="ALTMEMPHY"  version="9.1"  build="198"  iptb_version="1.3.0 Build 222"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="DDR2_IF_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "local_if_clk_mhz_label" value="83.3"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="Micron MT47H16M16BG-3"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_tcl_60_fmax" value="267.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="DDR2_IF_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="DDR2_IF_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+DDR2_IF_phy_alt_mem_phy_seq_wrapper;+DDR2_IF_phy_alt_mem_phy_reconfig;+DDR2_IF_phy_alt_mem_phy_pll;+DDR2_IF_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=H:\Projects\HD_SDI_Board\altera\17_5_2011\Top_HD_LogoInsert/DDR2_IF_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="DDR2_IF_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "quartus_settings">
// Retrieval info:      <PRIVATE name = "DEVICE" value="EP3C40F484C8"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "FAMILY" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// IPFS_FILES: DDR2_IF_phy_alt_mem_phy_seq_wrapper.vo;
// =========================================================
