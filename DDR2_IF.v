// megafunction wizard: %DDR2 High Performance Controller v9.1%
// GENERATION: XML

// ============================================================
// Megafunction Name(s):
// 			DDR2_IF_controller_phy
// ============================================================
// Generated by DDR2 High Performance Controller 9.1 [Altera, IP Toolbench 1.3.0 Build 222]
// ************************************************************
...
module DDR2_IF (
	...
	wire [13:0] signal_wire3 = 14'b0;
	wire [5:0] signal_wire4 = 6'b0;
	wire [5:0] signal_wire5 = 6'b0;
	wire signal_wire6 = 1'b0;
	wire [31:0] signal_wire7 = 32'b0;
	...
	wire [3:0] signal_wire17 = 4'b0;
	wire [2:0] signal_wire18 = 3'b0;
	wire signal_wire19 = 1'b0;
	wire [8:0] signal_wire20 = 9'b0;
	wire [3:0] signal_wire21 = 4'b0;
	...
	DDR2_IF_controller_phy	DDR2_IF_controller_phy_inst(
		...
		.oct_ctl_rs_value(signal_wire2),
		.oct_ctl_rt_value(signal_wire3),
		.dqs_delay_ctrl_import(signal_wire4),
		.dqs_offset_delay_ctrl(signal_wire5),
		.hc_scan_enable_access(signal_wire6),
		.hc_scan_enable_dq(signal_wire7),
		.hc_scan_enable_dm(signal_wire8),
		.hc_scan_enable_dqs(signal_wire9),
		.hc_scan_enable_dqs_config(signal_wire10),
		.hc_scan_din(signal_wire11),
		.hc_scan_update(signal_wire12),
		.hc_scan_ck(signal_wire13),
		.pll_reconfig_write_param(signal_wire14),
		.pll_reconfig_read_param(signal_wire15),
		.pll_reconfig(signal_wire16),
		.pll_reconfig_counter_type(signal_wire17),
		.pll_reconfig_counter_param(signal_wire18),
		.pll_reconfig_soft_reset_en_n(signal_wire19),
		.pll_reconfig_data_in(signal_wire20),
		.pll_phasecounterselect(signal_wire21),
		.pll_phaseupdown(signal_wire22),
		.pll_phasestep(signal_wire23),
		.pll_reconfig_enable(signal_wire24),
		.global_reset_n(global_reset_n),
		.local_autopch_req(signal_wire25),
		.local_self_rfsh_req(signal_wire26),
		.local_powerdn_req(signal_wire27),
...
// Retrieval info: <MEGACORE title="DDR2 SDRAM High Performance Controller"  version="9.1"  build="222"  iptb_version="1.3.0 Build 222"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="DDR2_IF_controller_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="DDR2_IF_auk_ddr_hp_controller_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "nativelink_excludes" value="DDR2_IF_phy_alt_mem_phy_seq.vhd,DDR2_IF_phy_alt_mem_phy_seq_wrapper.vhd,DDR2_IF_phy_alt_mem_phy_seq_wrapper.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="DDR2_IF_auk_ddr_hp_controller_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+DDR2_IF_alt_mem_phy_seq_wrapper;+DDR2_IF_alt_mem_phy_reconfig;+DDR2_IF_alt_mem_phy_pll;+DDR2_IF_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=H:\Projects\HD_SDI_Board\altera\17_5_2011\Top_HD_LogoInsert/DDR2_IF_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="DDR2_IF_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: DDR2_IF_auk_ddr_hp_controller_wrapper.v, auk_ddr_hp_controller.vhd, DDR2_IF_phy_alt_mem_phy_seq.vhd,DDR2_IF_phy_alt_mem_phy_seq_wrapper.vhd,DDR2_IF_phy_alt_mem_phy_seq_wrapper.v;
// IPFS_FILES: DDR2_IF_auk_ddr_hp_controller_wrapper.vo;
// =========================================================
